        ...
        <main style={{ background: '#ffffff', minHeight: '100vh' }}>
          <section style={{ background: '#F0F7F8', padding: '64px clamp(20px,6vw,80px) 48px' }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
              <div style={{ display: 'inline-block', padding: '5px 16px', borderRadius: 999, background: 'rgba(3,131,144,0.1)', border: '1px solid rgba(3,131,144,0.25)', fontSize: 11, fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase' as const, color: '#026B76', marginBottom: 20 }}>Правове</div>
          ...
          <section style={{ padding: '56px clamp(20px,6vw,80px)' }}>
            <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', flexDirection: 'column' as const, gap: 40 }}>
              ...
              {/* 7. Термін зберігання та видалення облікового запису */}
              <div>
                <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 20, fontWeight: 400, color: '#038390', marginBottom: 12, paddingBottom: 8, borderBottom: '1px solid #E6F4F5' }}>7. Термін зберігання даних та видалення облікового запису</h2>

                <div style={{ background: 'rgba(204,0,0,0.06)', border: '1px solid rgba(204,0,0,0.2)', borderRadius: 10, padding: '12px 20px', fontSize: 13, color: '#CC0000', marginBottom: 20 }}>
                  ⚠️ Чорновий текст цього розділу — потребує узгодження та перевірки кваліфікованим юристом (Rechtsanwalt/Datenschutzbeauftragter) перед публікацією. Це не є юридичною консультацією.
                </div>

                <p style={{ fontSize: 15, color: '#595959', lineHeight: 1.75, marginBottom: 20 }}>
                  Коли клієнт подає запит на видалення облікового запису, QLIXA видаляє персональні дані, які більше не є необхідними для жодної із визначених нижче цілей. Водночас частина даних, безпосередньо пов&apos;язана з поданими податковими деклараціями, зберігається протягом обмеженого строку на підставах, передбачених статтею 17(3) Загального регламенту про захист даних (GDPR/DSGVO), та з урахуванням законодавчих вимог Австрії щодо зберігання документів.
                </p>

                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#1A1A1A', marginBottom: 12 }}>Дані, що видаляються одразу після підтвердження запиту:</h3>
                <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 6, marginBottom: 24 }}>
                  {[
                    'Обліковий запис та автентифікаційні дані (email, пароль, налаштування двофакторної автентифікації).',
                    'Контактні дані, що не є частиною поданої декларації (телефон, налаштування сповіщень, історія входів у систему).',
                    'Налаштування інтерфейсу та інша технічна/сервісна інформація, не пов\'язана з податковою звітністю.',
                    'Пряме посилання на архівні дані клієнта в межах активної (робочої) бази даних платформи — після видалення обліковий запис і профіль клієнта в застосунку більше не існують і не використовуються.',
                  ].map(item => (
                    <div key={item} style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>• {item}</div>
                  ))}
                </div>

                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#1A1A1A', marginBottom: 12 }}>Дані, що зберігаються після видалення, і чому:</h3>
                <p style={{ fontSize: 14, color: '#595959', lineHeight: 1.7, marginBottom: 12 }}>
                  Зберігається лише знімок (копія) поданих клієнтом Анкети та податкової декларації за кожен рік, за який декларація подавалася через платформу. Це зберігання здійснюється на двох окремих правових підставах:
                </p>
                <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 10, marginBottom: 12 }}>
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.65 }}>
                    <strong>Ст. 17(3)(б) GDPR</strong> — виконання законного обов&apos;язку зберігання. Обов&apos;язок зберігати податково значущі документи протягом 7 років (§ 132 Федерального податкового кодексу Австрії, Bundesabgabenordnung, BAO) належить самому клієнту (Abgabepflichtiger). QLIXA зберігає ці дані від імені клієнта як уповноважений архіватор — на підставі згоди клієнта, наданої під час реєстрації / прийняття Умов використання <span style={{ color: '#CC0000', fontStyle: 'italic' }}>⚠️ [посилання на відповідний пункт Умов використання — уточнити з юристом]</span>.
                  </div>
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.65 }}>
                    <strong>Ст. 17(3)(д) GDPR</strong> — встановлення, здійснення або захист правових вимог. QLIXA зберігає за собою право утримувати ці дані для власного юридичного захисту у разі можливих судових або позасудових спорів, пов&apos;язаних з наданими послугами (наприклад, претензії щодо якості чи повноти підготовленої декларації).
                  </div>
                </div>
                <p style={{ fontSize: 13, color: '#CC0000', fontStyle: 'italic', lineHeight: 1.6, marginBottom: 24 }}>
                  ⚠️ Питання для юриста: чи достатньо посилання на ці дві підстави, чи потрібне окреме формулювання згоди клієнта саме на архівування QLIXA від його імені (а не лише загальна згода з Умовами використання).
                </p>

                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#1A1A1A', marginBottom: 12 }}>Спосіб і місце зберігання:</h3>
                <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 6, marginBottom: 24 }}>
                  {[
                    'Дані зберігаються у вигляді незмінного (immutable) знімку — PDF-версія поданої Анкети та Декларації станом на момент подання.',
                    'Зберігання здійснюється в ізольованому архівному сховищі, окремому від робочої (production) бази даних застосунку — без прямого зв\'язку з активним профілем клієнта та без використання в повсякденній роботі сервісу.',
                  ].map(item => (
                    <div key={item} style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>• {item}</div>
                  ))}
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>
                    • Доступ до архіву обмежений і надається лише за наявності законної підстави (наприклад, запит клієнта, вимога податкового органу, судовий спір). <span style={{ color: '#CC0000', fontStyle: 'italic' }}>⚠️ [деталі процедури доступу — узгодити з юристом: хто саме має право на доступ, чи потрібне логування запитів доступу]</span>
                  </div>
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>
                    • Дані в архіві не використовуються для маркетингу, аналітики чи будь-яких інших цілей, окрім описаних вище.
                  </div>
                </div>

                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#1A1A1A', marginBottom: 12 }}>Строк зберігання та остаточне видалення:</h3>
                <p style={{ fontSize: 14, color: '#595959', lineHeight: 1.7, marginBottom: 8 }}>
                  Архівний знімок зберігається протягом 7 років з кінця календарного року, у якому відповідна декларація була подана — цей строк відповідає законодавчій вимозі § 132 BAO. Після завершення цього строку дані остаточно та безповоротно видаляються з архівного сховища в автоматичному порядку.
                </p>
                <p style={{ fontSize: 13, color: '#CC0000', fontStyle: 'italic', lineHeight: 1.6, marginBottom: 24 }}>
                  ⚠️ Питання для юриста: чи достатньо єдиного строку 7 років для всіх випадків, чи потрібно окремо враховувати довший строк зберігання для документів, пов&apos;язаних із нерухомістю (22 роки за австрійським законодавством), якщо такі дані колись входитимуть до цього архіву.
                </p>

                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#1A1A1A', marginBottom: 12 }}>Права клієнта щодо архівних даних:</h3>
                <p style={{ fontSize: 14, color: '#595959', lineHeight: 1.7, marginBottom: 8 }}>
                  Навіть після видалення облікового запису клієнт зберігає право:
                </p>
                <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 6, marginBottom: 24 }}>
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>• Отримати копію збережених архівних даних за запитом.</div>
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>• Заперечити проти зберігання — таке заперечення розглядається індивідуально; воно не завжди підлягає задоволенню, якщо зберігання здійснюється на підставі законного обов&apos;язку (§ 132 BAO) або для захисту правових вимог QLIXA (ст. 17(3) GDPR), що прямо передбачено регламентом як виняток із права на видалення.</div>
                  <div style={{ fontSize: 14, color: '#1A1A1A', paddingLeft: 8, lineHeight: 1.6 }}>• Звернутися з питаннями щодо обробки цих даних за контактами, вказаними в розділі «Контакт» цієї Політики.</div>
                </div>

                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#1A1A1A', marginBottom: 12 }}>Прозорість:</h3>
                <p style={{ fontSize: 14, color: '#595959', lineHeight: 1.7 }}>
                  Ця практика зберігання даних після видалення облікового запису доводиться до відома клієнта до моменту подання першої декларації через платформу — у межах Умов використання та цієї Політики конфіденційності, відповідно до вимог статей 13–14 GDPR щодо прозорості обробки персональних даних.
                </p>
              </div>
