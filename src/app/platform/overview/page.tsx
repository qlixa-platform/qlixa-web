  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--gray)' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 16px 80px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <div style={{
            background: 'var(--peach-light)', borderRadius: 16, padding: '28px',
            ...
            <p style={{ fontSize: 14, lineHeight: 1.85, color: 'var(--charcoal)', marginBottom: 20 }}>
              ...
              {' '}— і QLIXA сама підказує, що можна списати, які витрати врахувати і як зекономити.
            </p>
