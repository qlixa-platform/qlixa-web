      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', width: '100%', display: 'flex', alignItems: 'center', gap: 64 }}>
        ...
        <div style={{ flex: '0 0 420px', maxWidth: 420, position: 'relative' }}>
          <div style={{ width: '100%', aspectRatio: '1/1', borderRadius: 32, overflow: 'hidden', background: '#E6F4F5', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 40px rgba(3,131,144,0.12)' }}>
            ...
            <img src="/for-who/frilanser.png" alt="Фрілансер" style={{ width: '85%', height: '85%', objectFit: 'contain' }} />
          </div>
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <h1 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 'clamp(36px,5vw,56px)', fontWeight: 400, color: '#1A1A1A', lineHeight: 1.1, letterSpacing: '-1.5px', marginBottom: 20 }}>Фрілансер</h1>
          <p style={{ fontSize: 17, color: '#595959', lineHeight: 1.75, marginBottom: 16, maxWidth: 480 }}>IT, дизайн, консалтинг, будь-яка вільна професія — веди справи без Steuerberater. QLIXA зробить все сам.</p>
