  ...
  return (
    <main style={{ minHeight: '100vh', background: '#F0F7F8', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 20px' }}>
      <div style={{ maxWidth: 600, textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 'clamp(32px,5vw,52px)', fontWeight: 400, color: '#1A1A1A', lineHeight: 1.1, letterSpacing: '-1px', marginBottom: 16 }}>Нерухомість</h1>
        <p style={{ fontSize: 16, color: '#595959', lineHeight: 1.75, marginBottom: 40 }}>Здаєш нерухомість або маєш дохід з кількох джерел — платформа врахує всі надходження та списання.</p>
