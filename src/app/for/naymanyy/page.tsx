...
const T: Record<string, any> = {
  UA: {
    badge: 'Для найманих працівників, самозайнятих, фрилансерів та інших',
    heroQ: 'Працюєш або маєш дохід в Австрії?',
    relatedLinks: [
    ...
    heroDesc: 'Не потрібно знати, що можна списати або куди це вписувати. Просто відповідай на зрозумілі запитання — QLIXA розбере саме твою ситуацію.',
    heroNote: 'Не потрібно бути бухгалтером — QLIXA проведе тебе крок за кроком.',
    h1Before: 'Підготуй свою податкову декларацію ',
    h1Emphasis: 'в Австрії',
    heroSubtext: 'QLIXA проведе тебе через персональну податкову анкету, перевірить можливі категорії списань, покаже попередній розрахунок можливого повернення та підготує повністю заповнену декларацію.',
    price: '19,90', period: '/ рік',
    priceNote: 'Разова оплата · доступ протягом податкового року',
    ctaMain: 'Почати розрахунок →',
    features: ['Особистий кабінет', 'Персональна автоматизована анкета', 'Аналіз твоєї ситуації', 'Перевірка можливих категорій списань', 'Попередній розрахунок можливого повернення', 'Повністю заповнена податкова декларація', 'Підготовка для подання через FinanzOnline'],

    block3H2: 'Не потрібно знати, що можна списати',
    block3Sub: 'QLIXA сама поставить правильні запитання.',
    block3P1: 'Тобі не потрібно знати, які списання стосуються саме тебе, або розбиратися в австрійських податкових правилах.',
    block3P2: 'Ти відповідаєш на прості запитання про роботу, сім\u2019ю, доходи, витрати та інші обставини — QLIXA підбирає наступні запитання залежно від твоїх відповідей.',
    quoteQ: 'Не знаєш, що можна списати?',
    quoteA: 'Тобі не потрібно знати. QLIXA запитає.',

    questionsLabel: 'QLIXA питає',
    questions: ['Чи маєш ти витрати, пов\u2019язані з роботою?', 'Ти працюєш частково або повністю з дому?', 'Чи маєш ти додаткові доходи?'],
    yes: 'Так', no: 'Ні',
    relevantLabel: 'QLIXA додає наступні релевантні питання',
    relevantItems: ['Робочі витрати', 'Сімейні обставини', 'Інші доходи (оренда, інвестиції)'],
    resultLabel: 'Попередній розрахунок',
    resultDesc: 'можливого повернення',
    resultAmount: '€1 248',
    flow1: 'Ти відповідаєш', flow2: 'QLIXA аналізує', flow3: 'Отримуєш результат',

    block5H2: 'Не потрібно згадувати все в останній день',
    block5Sub: 'Можеш додавати дані поступово протягом року або пройти всю анкету одразу.',
    ...
    categories: [
      ...
      { icon: '📈', title: 'Інвестиції та оренда', desc: 'Дохід від інвестицій, оренди або інших джерел.' },
    ...
    steps: [
      ...
      { n: '03', title: 'Розрахунок', desc: 'Отримаєш попередній розрахунок можливого повернення.' },
      { n: '04', title: 'Повністю заповнена декларація', desc: 'QLIXA формує готову до перевірки та подання податкову декларацію на основі твоїх відповідей.' },
    ],

    block8H2: 'Готовий підготувати свою декларацію?',
    block8Sub: 'Відповідай на прості запитання. QLIXA розбере твою ситуацію, покаже попередній результат та підготує декларацію.',
    ...
    faq: [
      ...
      { q: 'Чи подає QLIXA декларацію за мене?', a: 'Ні. Ти отримуєш повністю заповнену декларацію, перевіряєш її та подаєш самостійно через FinanzOnline. Рішення завжди залишається за тобою.' },
    ],
